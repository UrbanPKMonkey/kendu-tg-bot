...
from utils.build_buy_panel import build_sol_buy_panel

GECKO_URL = f"https://api.geckoterminal.com/api/v2/networks/solana/pools/{SOL_LP_ADDRESS}/swaps"
JSON_LOG = "buys_sol.json"
...
async def run_sol_buy_watcher(bot):
    print("👀 SOL buy watcher started")
    seen_tx_ids = set()
    buys = load_buys()
    ...
    while True:
        try:
            ...
            for s in swaps:
                ...
                print(f"💰 New SOL Buy: ${amount_usd} | {tokens} KENDU")
                buys.append(buy)
